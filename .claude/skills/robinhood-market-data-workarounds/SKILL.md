...
This skill applies only to the Stocks/robinhood InvestBot project; if approved, it would be installed at that repo's `.claude/skills/`, not as a global skill.
